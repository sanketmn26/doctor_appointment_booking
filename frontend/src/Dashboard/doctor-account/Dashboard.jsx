                  ...
                  <>
                    <div>
                      <div className="flex items-center gap-4 mb-10">
                        ...
                        <div>
                          <span className="bg-[#ccf0f3] text-irisBlueColor py-1 px-4 lg:py-2 lg:px-6 rounded text-[12px] leadning-4 lg:text-[16px] lg:leading-6 font-semibold">
                            {data.specialization}
                          </span>
